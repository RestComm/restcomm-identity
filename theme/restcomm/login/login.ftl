...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
		<div id="rc-bigtitle-area">
			<div id="rc-bigtitle-icon"></div>
			<div id="rc-bigtitle"></div>
		</div>
		<div id="realm-area">
			<h2>${msg("loginTitleHtml",(realm.displayNameHtml!''))} <span class='sub-heading'>realm</span></h2>
        </div>
    <#elseif section = "form">
        <#if realm.password>
